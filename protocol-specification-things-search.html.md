# Things - Search protocol specification
...
| **value**  | JSON object specifying the search query. [JSON Schema: jsonschema/protocol-search-subscribe-payload.json](../jsonschema/protocol-search-subscribe-payload.json) |
...
| **path**   | `/`     |
| **value**  | JSON object specifying the number of pages to request. [JSON Schema: jsonschema/protocol-search-request-payload.json](../jsonschema/protocol-search-request-payload.json) |
...
| **path**   | `/`     |
| **value**  | Identifies a search subscription. [JSON Schema: jsonschema/protocol-search-subscriptionid.json](../jsonschema/protocol-search-subscriptionid.json) |
...
| **path**   | `/`     |
| **value**  | Discloses the ID of a search subscription which all subsequent commands should include. [JSON Schema: jsonschema/protocol-search-subscriptionid.json](../jsonschema/protocol-search-subscriptionid.json) |
...
| **path**   | `/`     |
| **value**  | JSON object containing one page of the search results. [JSON Schema: jsonschema/protocol-search-next-payload.json](../jsonschema/protocol-search-next-payload.json) |
...
| **path**   | `/`     |
| **value**  | JSON object containing the reason for the failure. [JSON Schema: jsonschema/protocol-search-failed-payload.json](../jsonschema/protocol-search-failed-payload.json) |
