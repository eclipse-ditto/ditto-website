...
> **TL;DR**: Set `MONGO_DB_URI` and related environment variables to connect to your MongoDB instance. For MongoDB 6+, enable additional snapshot aggregation indexes to maintain query performance.
