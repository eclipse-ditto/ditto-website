...
> **Note:** The limit option is deprecated, it may be removed in future releases. Use [cursor-based 
...
> **Note:** We recommend **not to use high offsets** (e.g. higher than 10000) for paging
