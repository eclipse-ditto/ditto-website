...
> **Note:** **Since Ditto 3.7.3** there is a change in how the custom aggregation metrics are configured. See the [Release notes of 3.7.3](release_notes_373.html) for details on migration steps.

> **Warning:** Avoid grouping by fields with high cardinality, as this creates many metric series and may overload your Prometheus server.
