...
> **Warning:** If you want to upgrade an existing Ditto installation, the following database 
...
**Data in `policiesBasedSearchIndex` needs to be migrated (we strongly recommend to do that in "offline mode"
 ...
 [MongoDB migration script from 0.8.0-M2 to 0.8.0-M3](files/migration_mongodb_0.8.0-M2_0.8.0-M3.js).**
