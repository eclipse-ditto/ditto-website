...
> **TL;DR**: The topic path determines routing and authorization — Ditto uses it to resolve the target entity, select twin or live processing, and dispatch the correct command handler.
