...
> **TL;DR**: Add an `sshTunnel` section to your connection configuration with the SSH server URI and credentials. Ditto establishes local port forwarding and connects to the target endpoint through the tunnel.
...
> **Note:** SSH tunneling can impact transmission performance compared to a direct connection.
