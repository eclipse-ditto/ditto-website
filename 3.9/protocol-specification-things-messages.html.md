# Things - Messages protocol specification
...
> **TL;DR**: Messages carry arbitrary payloads over the live channel. You address them to a Thing's inbox (sending to a device) or outbox (sending from a device), and correlate request/response pairs via `correlation-id`.
...
> **Tip:** If you only need to send Messages, but don't need to receive
...
> **Tip:** If you want to receive the response to
...
> **Note:** We encourage you to play around with the examples. You can use
