...
> **TL;DR**: Ditto provides a ready-to-use backend for managing digital twins, so you can
interact with devices through HTTP, WebSocket, and messaging APIs without building a custom IoT backend.
...
> Ditto's goal is to eliminate the need to build and operate a custom IoT backend.
