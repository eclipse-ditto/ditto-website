...
> **TL;DR**: Send CloudEvents-formatted HTTP requests to `/api/2/cloudevents` with Ditto Protocol JSON as the payload and `ditto:` as the data schema prefix.
