...
| **value** | JSON object specifying the query. [JSON Schema: jsonschema/protocol-search-subscribe-payload.json](../jsonschema/protocol-search-subscribe-payload.json) |
...
| **path** | `/` |
| **value** | JSON object specifying the page count. [JSON Schema: jsonschema/protocol-search-request-payload.json](../jsonschema/protocol-search-request-payload.json) |
...
| **path** | `/` |
| **value** | JSON object identifying the subscription. [JSON Schema: jsonschema/protocol-search-subscriptionid.json](../jsonschema/protocol-search-subscriptionid.json) |
...
| **path** | `/` |
| **value** | JSON object with the subscription ID. [JSON Schema: jsonschema/protocol-search-subscriptionid.json](../jsonschema/protocol-search-subscriptionid.json) |
...
| **path** | `/` |
| **value** | JSON object with one page of results. [JSON Schema: jsonschema/protocol-search-next-payload.json](../jsonschema/protocol-search-next-payload.json) |
...
| **path** | `/` |
| **value** | JSON object with the failure reason. [JSON Schema: jsonschema/protocol-search-failed-payload.json](../jsonschema/protocol-search-failed-payload.json) |
