...
> **TL;DR**: Messages are fire-and-forget payloads routed through Ditto to or from
...
![Ditto Messages](images/pages/basic/ditto-messages.png)
*How Ditto acts as router for Messages*

> **Note:** Ditto has no knowledge of the payload of messages but routes messages between
connected devices.
...
> **Warning:** Ditto offers no message retention. If a device is not connected when a message is
   routed, it will never receive the message.

> **Warning:** Ditto makes no statement about message QoS. Messages are routed **at most once**.

> **Warning:** Ditto delivers messages in a fan-out style. If the same credentials are connected
