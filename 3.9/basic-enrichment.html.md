...
> **TL;DR**: Use `extraFields` when subscribing to events or messages to include
additional Thing data (like attributes or related properties) in each delivered signal.
...
> **Note:** Deleted events cannot be enriched with the deleted values.
