...
> **TL;DR**: Ditto uses five signal types: Commands (requests to read or change data),
Command Responses (success replies), Error Responses (failure replies), Events (records of changes
that already happened), and Announcements (advance notices of upcoming changes).
