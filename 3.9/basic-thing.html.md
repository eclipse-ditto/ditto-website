...
> **TL;DR**: A Thing is a JSON object with an ID, a Policy reference, optional
attributes (static metadata), and optional features (dynamic state data).
...
![Thing and Feature](images/pages/basic/ditto-thing-feature.png)
*One Thing can have
many Features*
