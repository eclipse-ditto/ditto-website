...
> **TL;DR**: A Thing has attributes (static metadata) and features (dynamic state). A
Policy controls who can read and write each part. That is the entire data model.
