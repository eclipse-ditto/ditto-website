...
> **TL;DR**: Every protocol interaction follows the pattern: send a **command**, receive a **response** (success or error), and optionally observe an **event**. Use `correlation-id` to link related messages.
