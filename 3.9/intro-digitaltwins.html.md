...
> **TL;DR**: A digital twin mirrors a physical device as a JSON data structure in the
cloud, giving your applications a single, always-available source of truth about that device.
