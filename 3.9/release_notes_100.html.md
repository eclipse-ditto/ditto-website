...
> **Warning:** If you want to upgrade an existing Ditto installation to 1.0.0, the following database migration has to be done 
...
[MongoDB migration script](files/migration_mongodb_1.0.0.js)
