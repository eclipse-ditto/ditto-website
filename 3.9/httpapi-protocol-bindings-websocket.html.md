...
> **TL;DR**: Connect to `ws://localhost:8080/ws/2`, send Ditto Protocol JSON messages, and subscribe to events, messages, or live commands using plain-text control messages like `START-SEND-EVENTS`.
