...
> **TL;DR**: A Ditto Protocol message is a JSON object with `topic`, `headers`, `path`, and `value` fields. The topic identifies the entity and action; headers carry metadata; path and value specify what to change.
