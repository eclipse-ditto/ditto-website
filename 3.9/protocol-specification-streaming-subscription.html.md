...
| **path** | `/` |
| **value** | JSON object specifying start/stop options. [JSON Schema: jsonschema/protocol-streaming-subscription-subscribe-for-persisted-events-payload.json](../jsonschema/protocol-streaming-subscription-subscribe-for-persisted-events-payload.json) |
...
| **path** | `/` |
| **value** | JSON object specifying the demand. [JSON Schema: jsonschema/protocol-streaming-subscription-request-payload.json](../jsonschema/protocol-streaming-subscription-request-payload.json) |
...
| **path** | `/` |
| **value** | JSON object identifying the subscription. [JSON Schema: jsonschema/protocol-streaming-subscriptionid.json](../jsonschema/protocol-streaming-subscriptionid.json) |
...
| **path** | `/` |
| **value** | JSON object with the subscription ID. [JSON Schema: jsonschema/protocol-streaming-subscriptionid.json](../jsonschema/protocol-streaming-subscriptionid.json) |
...
| **path** | `/` |
| **value** | JSON object with one result item. [JSON Schema: jsonschema/protocol-streaming-subscription-next-payload.json](../jsonschema/protocol-streaming-subscription-next-payload.json) |
...
| **path** | `/` |
| **value** | JSON object with the failure reason. [JSON Schema: jsonschema/protocol-streaming-subscription-failed-payload.json](../jsonschema/protocol-streaming-subscription-failed-payload.json) |
