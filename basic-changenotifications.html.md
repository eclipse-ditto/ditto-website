...
> **Note:** All filters are specified in a URL query format, therefore their values should be URL
...
> **Note:** This filter is *by default* applied on the modified data of a Thing.
