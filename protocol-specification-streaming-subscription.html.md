# Streaming subscription protocol specification
...
| **path**   | `/`                                                                                                                                                                                                       |
| **value**  | JSON object specifying the options how the persisted events should be selected. [JSON Schema: jsonschema/protocol-streaming-subscription-subscribe-for-persisted-events-payload.json](../jsonschema/protocol-streaming-subscription-subscribe-for-persisted-events-payload.json) |
...
| **path**   | `/`                                                                                                                                              |
| **value**  | JSON object specifying the demand of results. [JSON Schema: jsonschema/protocol-streaming-subscription-request-payload.json](../jsonschema/protocol-streaming-subscription-request-payload.json) |
...
| **path**   | `/`                                                                                                                       |
| **value**  | Identifies a streaming subscription. [JSON Schema: jsonschema/protocol-streaming-subscriptionid.json](../jsonschema/protocol-streaming-subscriptionid.json) |
...
| **path**   | `/`                                                                                                                                                                             |
| **value**  | Discloses the ID of a streaming subscription which all subsequent commands should include. [JSON Schema: jsonschema/protocol-streaming-subscriptionid.json](../jsonschema/protocol-streaming-subscriptionid.json) |
...
| **path**   | `/`                                                                                                                                             |
| **value**  | JSON object containing one item of the results. [JSON Schema: jsonschema/protocol-streaming-subscription-next-payload.json](../jsonschema/protocol-streaming-subscription-next-payload.json) |
...
| **path**   | `/`                                                                                                                                                  |
| **value**  | JSON object containing the reason for the failure. [JSON Schema: jsonschema/protocol-streaming-subscription-failed-payload.json](../jsonschema/protocol-streaming-subscription-failed-payload.json) |
